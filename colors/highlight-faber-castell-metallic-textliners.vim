" Name: Highlight Faber-Castell Metallic Textliners
...
let g:colors_name = "highlight-faber-castell-metallic-textliner"

set background=light

" This theme depends on termguicolors being set.

" Colors taken from the faber-castell metallic textliner scansfrom scans
...
let s:palette.visual    = '#e4e7e3' " Shiny Silver 

" Colors taken from the Gentle Zebra highlighter color pack
let s:palette.magenta   = '#e7d5db' " Brilliant Ruby 
let s:palette.yellow    = '#f9e1a2' " Glamorous Gold
let s:palette.red       = '#f0b9b5' " Glorious Red
let s:palette.orange    = '#e8c183' " Saturated Glamorous Gold 
let s:palette.blue      = '#cfe4ee' " Magnificent Blue
let s:palette.green     = '#bfdcda' " Precious Green
let s:palette.darkgreen = '#99bbb3' " Green from a more saturated part (for SpecialChar)
