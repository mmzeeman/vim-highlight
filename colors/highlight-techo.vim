" Name: Highlight Hobonichi Techo Matching Colorscheme 
...
let g:colors_name = "highlight-techo"

set background=light

" This theme depends on termguicolors being set.

" Colors taken from Hobonichi Techo highligher set from Jetpens. The colors
" where picked from the scans found on https://www.jetpens.com

let s:palette = {}

let s:palette.bg        = '#ffffff' " Paper  
let s:palette.fg        = '#000000' " Black

" Color for visual selection and matching parens
let s:palette.visual    = '#f0cab5' " Monami Essenti Soft Highlighter

" Colors taken from the Gentle Zebra highlighter color pack
let s:palette.magenta   = '#e8d4fb' " Zebra Midliner Mild Iris 
let s:palette.yellow    = '#fff1d2' " Stabilo Swing Cool Earth Beige
let s:palette.red       = '#fdd2d7' " Pilot Frixion Natural Color Erasable Red
let s:palette.orange    = '#f9b397' " Zebra Midliner Vermillion 
let s:palette.blue      = '#cae1fe' " Kokuyo Mark (dark blue)
let s:palette.green     = '#d9e6dc' " Stabilo Swing Cool Earth Green
let s:palette.darkgreen = '#a7bfb0' " Stabilo Swing Cool Earth Green from a more saturated part (for SpecialChar)
